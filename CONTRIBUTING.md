Contributing to AileCoin Core
==================================

The AileCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AileCoin Core project, and is not to be
confused with overall AileCoin Network Protocol consensus changes.

Whether a pull request is merged into AileCoin Core rests with the project merge
...
Patches that change AileCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AileCoin consensus, it must have been
...
The project leader is the release manager for each AileCoin Core release.
