Contributing to AILE Core
============================

The AILE Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/aile-project/aile/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AILE Core project, and is not to be
confused with overall AILE Network Protocol consensus changes.

Whether a pull request is merged into AILE Core rests with the project merge
...
Patches that change AILE consensus rules are considerably more involved than
...
Where a patchset proposes to change the AILE consensus, it must have been
...
The project leader is the release manager for each AILE Core release.
