...
RESOURCES += src/qt/aile.qrc src/qt/aile_locale.qrc

TRANSLATIONS += src/qt/locale/aile_bg.ts \
                src/qt/locale/aile_de.ts \
                src/qt/locale/aile_en.ts \
                src/qt/locale/aile_es.ts \
                src/qt/locale/aile_fi.ts \
                src/qt/locale/aile_fr.ts \
                src/qt/locale/aile_it.ts \
                src/qt/locale/aile_ja.ts \
                src/qt/locale/aile_pl.ts \
                src/qt/locale/aile_pt.ts \
                src/qt/locale/aile_ru.ts \
                src/qt/locale/aile_sk.ts \
                src/qt/locale/aile_sv.ts \
                src/qt/locale/aile_vi.ts \
                src/qt/locale/aile_zh_CN.ts \
                src/qt/locale/aile_zh_TW.ts
