...
RESOURCES += src/qt/ailecoin.qrc src/qt/ailecoin_locale.qrc

TRANSLATIONS += src/qt/locale/ailecoin_bg.ts \
                src/qt/locale/ailecoin_de.ts \
                src/qt/locale/ailecoin_en.ts \
                src/qt/locale/ailecoin_es.ts \
                src/qt/locale/ailecoin_fi.ts \
                src/qt/locale/ailecoin_fr.ts \
                src/qt/locale/ailecoin_it.ts \
                src/qt/locale/ailecoin_ja.ts \
                src/qt/locale/ailecoin_pl.ts \
                src/qt/locale/ailecoin_pt.ts \
                src/qt/locale/ailecoin_ru.ts \
                src/qt/locale/ailecoin_sk.ts \
                src/qt/locale/ailecoin_sv.ts \
                src/qt/locale/ailecoin_vi.ts \
                src/qt/locale/ailecoin_zh_CN.ts \
                src/qt/locale/ailecoin_zh_TW.ts
