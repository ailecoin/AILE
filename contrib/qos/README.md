...
This means one can have an always-on ailed instance running, and another local ailed/aile-qt instance which connects to this node and receives blocks from it.
