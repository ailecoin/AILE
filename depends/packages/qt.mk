...
$(package)_patches=aile-qmake.conf aarch32-qmake.conf aarch64-qmake.conf mingw-uuidof.patch pidlist_absolute.patch fix-xcb-include-order.patch fix_qt_pkgconfig.patch
...
define $(package)_preprocess_cmds
  ...
  cp -f $($(package)_patch_dir)/aile-qmake.conf qtbase/mkspecs/macx-clang-linux/qmake.conf && \
