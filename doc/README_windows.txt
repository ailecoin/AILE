...
Intro
-----
AileCoin (AILE) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. AileCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ailecoin-qt.exe.

AileCoin Core is the original AileCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of AileCoin transactions;
