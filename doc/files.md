...
aile.conf           | contains configuration settings for ailed or aile-qt
ailed.pid           | stores the process id of ailed while running
...
debug.log           | contains debug information and general logging generated by ailed or aile-qt
