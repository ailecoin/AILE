...
AileCoin now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ailecoin_address\> \<monthly_payment_ailecoin\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _5000_ AILE, _12_ times over the course of a year totaling _60000_ AILE.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ailecoin_address\> \<monthly_payment_ailecoin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `5000` AILE.
 ...
 * vote-many          - Vote on a AileCoin initiative
 * vote-alias         - Vote on a AileCoin initiative
 * vote               - Vote on a AileCoin initiative/budget
