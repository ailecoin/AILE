...
In order to support loading of multiple wallets in ailecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ailecoin.cpp.
...
Changes to ailecoin.cpp
----------------------
ailecoin.cpp is the entry point into ailecoin-qt, and as such, will require some minor modifications to provide hooks for
