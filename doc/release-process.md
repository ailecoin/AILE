...
- Detached signatures will then be committed to the [ailecoin-detached-sigs](https://github.com/pointofpublic/pointofpublic-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
