...
This mechanism has been integrated into Bitcore-Node-AileCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/AileCoin/insight-api-ailecoin#web-socket-api](https://github.com/AileCoin/insight-api-ailecoin#web-socket-api)
* API: [https://github.com/AileCoin/insight-api-ailecoin#swifttx-transactions](https://github.com/AileCoin/insight-api-ailecoin#swifttx-transactions)
...
By default, the AileCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AileCoin Core daemon:
