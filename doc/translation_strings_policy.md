...
This document provides guidelines for internationalization of the AILE Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to AILE network</numerusform>
            <numerusform>%n active connections to AILE network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aile_en.ts` remains unchanged.
