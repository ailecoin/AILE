...
#   c) node1 mines 32 blocks, so now node 0 has 500000AILE, node 1 has 4250AILE, node2 has none.
#   d) node0 sends 601 AILE to node2, in two transactions (301 AILE, then 300 AILE).
