...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("AileCoin Core ailecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ailecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ailecoin transaction") + "\n" +
                               "  ailecoin-tx [options] -create [commands]   " + _("Create hex-encoded ailecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ailecoin transaction
