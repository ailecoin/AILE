 ...
 * AILE system. There are three: the main network on which people trade goods
...
public:
    ...
    int AileBadBlockTime() const { return nAileBadBlockTime; }
    int AileBadBlocknBits() const { return nAileBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nAileBadBlockTime;
    unsigned int nAileBadBlocknBits;
