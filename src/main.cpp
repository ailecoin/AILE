...
#if defined(NDEBUG)
#error "AileCoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET) {
             if (nHeight >=   1 && nHeight <=      1) {nSubsidy =      10.00 * COIN;}
        else if (nHeight >=   2 && nHeight <=   5000) {nSubsidy =      10.30 * COIN;}
        else if (nHeight >=   5001                  ) {nSubsidy =      10.50 * COIN;}

        return nSubsidy;
    }

         if (nHeight >=      1 && nHeight <=      1) {nSubsidy =  200000000.00 * COIN;}
    else if (nHeight >=      2 && nHeight <=  43200) {nSubsidy =        150.00 * COIN;}
    else if (nHeight >=  43201 && nHeight <=  86400) {nSubsidy =        160.00 * COIN;}
    else if (nHeight >=  86401 && nHeight <= 129600) {nSubsidy =        170.00 * COIN;}
    else if (nHeight >= 129601 && nHeight <= 172800) {nSubsidy =        180.00 * COIN;}
    else if (nHeight >= 172801 && nHeight <= 216000) {nSubsidy =        190.00 * COIN;}
    else if (nHeight >= 216001 && nHeight <= 259200) {nSubsidy =        200.00 * COIN;}
    else if (nHeight >= 259201 && nHeight <= 302400) {nSubsidy =        210.00 * COIN;}
    else if (nHeight >= 302401 && nHeight <= 345600) {nSubsidy =        220.00 * COIN;}
    else if (nHeight >= 345601 && nHeight <= 388800) {nSubsidy =        230.00 * COIN;}
    else if (nHeight >= 388801 && nHeight <= 432000) {nSubsidy =        240.00 * COIN;}
    else if (nHeight >= 432001 && nHeight <= 475200) {nSubsidy =        250.00 * COIN;}
    else if (nHeight >= 475201 && nHeight <= 518400) {nSubsidy =        200.00 * COIN;}
    else if (nHeight >= 518401                     ) {nSubsidy =        150.00 * COIN;}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        ...
        else if (nHeight >=         2 && nHeight <=      300) {nSubsidy = 0;}
        else if (nHeight >=       301 && nHeight <=     1000) {nSubsidy = blockValue * 0.80;}
        else if (nHeight >=      1001                       ) {nSubsidy = blockValue * 0.90;}

        return nSubsidy;
    }

             if (nHeight >=      1 && nHeight <=          300) {nSubsidy = 0;}
        else if (nHeight >=    301                           ) {nSubsidy = blockValue * 0.85;}
...
{
    RenameThread("ailecoin-scriptch");
