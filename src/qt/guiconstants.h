...
/* Aile GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AILE"
#define QAPP_ORG_DOMAIN "aile.org"
#define QAPP_APP_NAME_DEFAULT "AILE-Qt"
#define QAPP_APP_NAME_TESTNET "AILE-Qt-testnet"
