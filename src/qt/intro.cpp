...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AileCoin Core"),
     ...
     * override -datadir in the ailecoin.conf file in the default data directory
     * (to be consistent with ailecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
