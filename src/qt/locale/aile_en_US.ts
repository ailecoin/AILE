...
<context>
    ...
    <message>
        <source>To use ailed, or the -server option to aile-qt, you must set an rpcpassword in the configuration file:
%s
...
for example: alertnotify=echo %%s | mail -s "AILE Alert" admin@foo.com
        ...
        <translation>To use ailed, or the -server option to aile-qt, you must set an rpcpassword in the configuration file:
%s
It is recommended you use the following random password:
rpcuser=ailerpc
rpcpassword=%s
