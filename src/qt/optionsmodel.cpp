...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::AILE);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeAileAmount"))
        SoftSetArg("-anonymizeaileamount", settings.value("nAnonymizeAileAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in aile.cpp during shotdown to also remove the window positions
