...
// Repair parameters
const QString AILECOINWALLET("-ailecoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_ailecoinwallet, SIGNAL(clicked()), this, SLOT(walletAileCoin()));
...
/** Restart wallet with "-ailecoinwallet" */
void RPCConsole::walletAileCoin()
{
    buildParameterlist(AILECOINWALLET);
}
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AileCoin RPC console.") + "<br>" +
