                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzAILEPathCustom = GetArg("-zailebackuppath", "");
    ...
    if(!strzAILEPathCustom.empty()) {
        ui->wallet_customzailebackuppath->setText(QString::fromStdString(strzAILEPathCustom));
        ui->wallet_customzailebackuppath_label->setVisible(true);
        ui->wallet_customzailebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzAILEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the AILE RPC console.") + "<br>" +
