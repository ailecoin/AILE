...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AILE features */
        {"aile", "listmasternodes", &listmasternodes, true, true, false},
        {"aile", "getmasternodecount", &getmasternodecount, true, true, false},
        {"aile", "masternodeconnect", &masternodeconnect, true, true, false},
        {"aile", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"aile", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"aile", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"aile", "masternodecurrent", &masternodecurrent, true, true, false},
        {"aile", "masternodedebug", &masternodedebug, true, true, false},
        {"aile", "startmasternode", &startmasternode, true, true, false},
        {"aile", "createmasternodekey", &createmasternodekey, true, true, false},
        {"aile", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"aile", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"aile", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"aile", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"aile", "getmasternodescores", &getmasternodescores, true, true, false},
        {"aile", "preparebudget", &preparebudget, true, true, false},
        {"aile", "submitbudget", &submitbudget, true, true, false},
        {"aile", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"aile", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"aile", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"aile", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"aile", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"aile", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"aile", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"aile", "checkbudgets", &checkbudgets, true, true, false},
        {"aile", "mnsync", &mnsync, true, true, false},
        {"aile", "spork", &spork, true, true, false},
        {"aile", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzaileseed", &getzaileseed, false, false, true},
        {"zerocoin", "setzaileseed", &setzaileseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzaile", &searchdzaile, false, false, true},
        {"zerocoin", "dzailestate", &dzailestate, false, false, true},
...
{
    return "> aile-cli " + methodname + " " + args + "\n";
}
