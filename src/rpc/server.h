...
extern UniValue setzaileseed(const UniValue& params, bool fHelp);
extern UniValue getzaileseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzaile(const UniValue& params, bool fHelp);
extern UniValue dzailestate(const UniValue& params, bool fHelp);
