...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AileCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "AileCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AileCoin features */
        {"ailecoin", "masternode", &masternode, true, true, false},
        {"ailecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ailecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ailecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ailecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ailecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ailecoin", "startmasternode", &startmasternode, true, true, false},
        {"ailecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ailecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ailecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ailecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ailecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ailecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ailecoin", "mnbudget", &mnbudget, true, true, false},
        {"ailecoin", "preparebudget", &preparebudget, true, true, false},
        {"ailecoin", "submitbudget", &submitbudget, true, true, false},
        {"ailecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ailecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ailecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ailecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ailecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ailecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ailecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ailecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ailecoin", "mnsync", &mnsync, true, true, false},
        {"ailecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> ailecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:39872/\n";
}
