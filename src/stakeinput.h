...
#ifndef AILE_STAKEINPUT_H
#define AILE_STAKEINPUT_H
...
// zAILEStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zaile, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZAILE() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZAILE() override { return false; }
