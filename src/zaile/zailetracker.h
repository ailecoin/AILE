...
#ifndef AILE_ZAILETRACKER_H
#define AILE_ZAILETRACKER_H
...
public:
    CzAILETracker(std::string strWalletFile);
    ~CzAILETracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzAILEWallet* zAILEWallet = NULL);
