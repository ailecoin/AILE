...
#ifndef AILE_ZAILEWALLET_H
#define AILE_ZAILEWALLET_H
...
public:
    CzAILEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZAILE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZAILE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
