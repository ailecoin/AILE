...
from fake_stake.base_test import AILE_FakeStakeTest

class zAILEwrappedSerialsTest(AILE_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zAILEs..." % DENOM_TO_USE)
